...
# This project is now archived, see #15 for details.

This was a fork from the primary repo for Space Station 14 called Nepu Station. To prevent people forking RobustToolbox, a "content" pack is loaded by the client and server. This content pack contains everything needed to play the game on one specific server this is the content pack for Goob Station.
