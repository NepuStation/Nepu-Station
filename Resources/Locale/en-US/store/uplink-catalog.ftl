...
uplink-pistol-cobra-desc = A rugged, robust operator handgun with inbuilt silencer. Uses 5.7mm caseless magnum, comes loaded with a hollow-point magazine.
...
uplink-sniper-ammo-name = Ammunition box (.60 antimaterial)
